                    ...
                    <thead>
                                  <tr>
                                    <th>Your Senators</th>
                                    <th>Their response to Charlottesville</th>
                                    <th>Call Script</th>
                                  </tr>
                                </thead>
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>@if (isset($position_5->position)) <a href="{{ $position_5->vote }}" target="_blank">{{ $position_5->position }}</a> @endif</td>
                                          ...
                                          <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                <p>{!! str_replace('<name>', $senator_1->last_name, $position_5->script) !!}</p>
                                              </div>
                                  ...
                                  <tr>
                                    ...
                                    <td>@if (isset($position_5->position)) <a href="{{ $position_6->vote }}" target="_blank">{{ $position_6->position }}</a> @endif</td>
                                        ...
                                        <div id="myModal2" class="modal fade" role="dialog">
                                          <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                {!! str_replace('<name>', $senator_2->last_name, $position_6->script) !!}
                                              </div>
                                              <div class="modal-footer">
                                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                              </div>
