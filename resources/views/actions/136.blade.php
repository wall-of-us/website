                    ...
                    <thead>
                                  <tr>
                                    <th>Your Senators</th>
                                    <th>Their stance on the Senate's healthcare bill</th>
                                    <th>Call Script</th>
                                  </tr>
                                </thead>
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td>@if (isset($position_3->position)) {{ $position_3->position }} @endif</td>
                                          ...
                                          <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                <p>{!! str_replace('<senator>', $senator_1->last_name, $position_3->script) !!}</p>
                                              </div>
                                  ...
                                  <tr>
                                    ...
                                    <td>@if (isset($position_3->position)) {{ $position_4->position }} @endif</td>
                                        ...
                                        <div id="myModal2" class="modal fade" role="dialog">
                                          <div class="modal-dialog">
                                            ...
                                            <div class="modal-content">
                                              ...
                                              <div class="modal-body">
                                                {!! str_replace('<senator>', $senator_2->last_name, $position_4->script) !!}
                                              </div>
                                              <div class="modal-footer">
                                                <button type="button" class="btn btn-default" data-dismiss="modal">Close</button>
                                              </div>
                              ...
                              @else
                                You must <a href="/login">login</a> to see the positions and contact info for your Senators.
                            @endif
